...
config_path = os.path.join(PROJECT_ROOT, "configs", "pretrain_config.yaml")
...
def main():
    ...
    # Save the model
    torch.save(model.state_dict(), "nano_gpt_shakespeare.pt")
    if use_wandb:
        wandb.save("nano_gpt_shakespeare.pt")
    
    print("\nTraining completed!")
    print(f"Model saved as 'nano_gpt_shakespeare.pt'")
